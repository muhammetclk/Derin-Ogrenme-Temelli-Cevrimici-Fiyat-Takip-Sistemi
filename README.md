...
3.1.1.1. React 
JavaScript uygulamaları geliştirmek için bir kütüphanedir. Kullanıcı arayüzü bileşenlerini oluşturmak ve yönetmek için kullanılır. React [33], sanal DOM (Document Object Model) kullanarak performansı artırır. Sanal DOM, gerçek DOM ağacının hafızada bir kopyasını oluşturur ve her güncellemede bu kopyayı gerçek DOM ile karşılaştırır. Bu sayede sadece değişen parçalar güncellenir, bu da uygulamanın daha verimli çalışmasını sağlar.
3.1.1.2. Vite 
